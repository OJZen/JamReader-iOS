...
struct ImageSequenceReaderContainerView: UIViewControllerRepresentable {
    ...
    final class LegacyPageCoordinator: NSObject, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
        ...
        func pageViewController(
            ...
            guard let controller = controller(forSpreadIndex: targetSpreadIndex) else {
                return nil
            }
