# YACReader iOS Figma Screen Spec

更新时间：2026-04-01

## 1. 这份文档解决什么问题

如果说 `yacreader-ios-ui-redesign-blueprint.md` 负责回答“应该设计成什么气质”，那这份文档负责回答“在 Figma 里具体要画哪些页面、用哪些尺寸、组件怎么搭”。

推荐把两份文档配合使用：

- 总方向与页面原则：`docs/yacreader-ios-ui-redesign-blueprint.md`
- 具体搭建与交付：`docs/yacreader-ios-figma-screen-spec.md`
- 核心页面文案与示例内容：`docs/yacreader-ios-priority-screen-content-spec.md`
