# YACReader iOS Priority Screen Content Spec
...
- 总体方向：`docs/yacreader-ios-ui-redesign-blueprint.md`
- Figma 搭建结构：`docs/yacreader-ios-figma-screen-spec.md`
- 高保真搭建配方：`docs/yacreader-ios-priority-frame-recipes.md`
- 产品行为依据：`docs/yacreader-ios-product-engineering-spec.md`
