# JamReader iOS Priority Frame Recipes
...
- `jamreader-ios-ui-redesign-blueprint.md` 负责方向
- `jamreader-ios-figma-screen-spec.md` 负责搭建规则
- `jamreader-ios-priority-screen-content-spec.md` 负责内容和文案
- `jamreader-ios-priority-frame-recipes.md` 负责具体怎么摆
