# YACReader iOS Design Handoff Index
...
- 外部目录只作为漫画内容源，不再兼容桌面 `library.ydb` / `.yacreaderlibrary`。
...
1. `docs/yacreader-ios-product-engineering-spec.md`
2. `docs/ui-design-requirements.md`
3. `docs/yacreader-ios-ui-redesign-blueprint.md`

### 1.2 再开始搭 Figma

4. `docs/yacreader-ios-figma-screen-spec.md`
5. `docs/yacreader-ios-priority-screen-content-spec.md`
6. `docs/yacreader-ios-priority-frame-recipes.md`

## 2. 每份文档负责什么

### `yacreader-ios-product-engineering-spec.md`
...
### `yacreader-ios-ui-redesign-blueprint.md`

负责视觉方向、组件语言、页面原则和 Figma 组织策略。

### `yacreader-ios-figma-screen-spec.md`

负责参考画板、尺寸、组件规格、页面清单和低保真线框。

### `yacreader-ios-priority-screen-content-spec.md`

负责核心页面文案、section 命名、按钮名、badge 文案和示例数据。

### `yacreader-ios-priority-frame-recipes.md`
...
- 直接按 `yacreader-ios-priority-frame-recipes.md` 开始画高保真稿
